...
func (o *RegisterUserParams) WithBody(body *models.UserspbRegisterUserRequest) *RegisterUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the register user params
func (o *RegisterUserParams) SetBody(body *models.UserspbRegisterUserRequest) {
	o.Body = body
}
