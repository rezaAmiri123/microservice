...
type DisableUserParams struct {
	...
	// Body.
	Body *models.UserspbDisableUserRequest
...
func (o *DisableUserParams) WithBody(body *models.UserspbDisableUserRequest) *DisableUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the disable user params
func (o *DisableUserParams) SetBody(body *models.UserspbDisableUserRequest) {
	o.Body = body
}
