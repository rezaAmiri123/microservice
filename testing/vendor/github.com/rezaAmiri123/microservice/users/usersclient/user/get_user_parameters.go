...
type GetUserParams struct {
	...
	// Body.
	Body *models.UserspbGetUserRequest
...
func (o *GetUserParams) WithBody(body *models.UserspbGetUserRequest) *GetUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get user params
func (o *GetUserParams) SetBody(body *models.UserspbGetUserRequest) {
	o.Body = body
}
