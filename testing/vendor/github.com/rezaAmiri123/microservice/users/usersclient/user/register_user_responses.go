...
func (o *RegisterUserOK) Error() string {
	return fmt.Sprintf("[POST /v1/register_user][%d] registerUserOK  %+v", 200, o.Payload)
}
...
func (o *RegisterUserDefault) Error() string {
	return fmt.Sprintf("[POST /v1/register_user][%d] registerUser default  %+v", o._statusCode, o.Payload)
}
