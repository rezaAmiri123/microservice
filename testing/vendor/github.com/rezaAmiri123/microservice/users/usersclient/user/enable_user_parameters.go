...
type EnableUserParams struct {
	...
	// Body.
	Body *models.UserspbEnableUserRequest
...
// WithDefaults hydrates default values in the enable user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *EnableUserParams) WithDefaults() *EnableUserParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the enable user params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *EnableUserParams) SetDefaults() {
...
// WithBody adds the body to the enable user params
func (o *EnableUserParams) WithBody(body *models.UserspbEnableUserRequest) *EnableUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the enable user params
func (o *EnableUserParams) SetBody(body *models.UserspbEnableUserRequest) {
	o.Body = body
}
