...
type UpdateUserParams struct {
	...
	// Body.
	Body *models.UserspbUpdateUserRequest
...
func (o *UpdateUserParams) WithBody(body *models.UserspbUpdateUserRequest) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UserspbUpdateUserRequest) {
	o.Body = body
}
