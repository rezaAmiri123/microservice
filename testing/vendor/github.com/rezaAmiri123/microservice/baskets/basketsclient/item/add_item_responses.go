...
func (o *AddItemOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/add_item][%d] addItemOK  %+v", 200, o.Payload)
}
...
func (o *AddItemDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/add_item][%d] addItem default  %+v", o._statusCode, o.Payload)
}
