...
func (o *RemoveItemOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/remove_item][%d] removeItemOK  %+v", 200, o.Payload)
}
...
func (o *RemoveItemDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/remove_item][%d] removeItem default  %+v", o._statusCode, o.Payload)
}
