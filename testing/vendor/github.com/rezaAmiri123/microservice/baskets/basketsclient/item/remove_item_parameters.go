...
type RemoveItemParams struct {
	...
	// Body.
	Body *models.BasketspbRemoveItemRequest
...
func (o *RemoveItemParams) WithBody(body *models.BasketspbRemoveItemRequest) *RemoveItemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the remove item params
func (o *RemoveItemParams) SetBody(body *models.BasketspbRemoveItemRequest) {
	o.Body = body
}
