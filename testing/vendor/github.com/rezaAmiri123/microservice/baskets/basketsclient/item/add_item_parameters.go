...
type AddItemParams struct {
	...
	// Body.
	Body *models.BasketspbAddItemRequest
...
func (o *AddItemParams) WithBody(body *models.BasketspbAddItemRequest) *AddItemParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add item params
func (o *AddItemParams) SetBody(body *models.BasketspbAddItemRequest) {
	o.Body = body
}
