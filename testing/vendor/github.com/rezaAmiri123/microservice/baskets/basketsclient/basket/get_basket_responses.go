...
func (o *GetBasketOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/get_basket][%d] getBasketOK  %+v", 200, o.Payload)
}
...
func (o *GetBasketDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/get_basket][%d] getBasket default  %+v", o._statusCode, o.Payload)
}
