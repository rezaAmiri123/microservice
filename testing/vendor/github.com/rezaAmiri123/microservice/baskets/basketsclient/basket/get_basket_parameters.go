...
type GetBasketParams struct {
	...
	// Body.
	Body *models.BasketspbGetBasketRequest
...
// WithBody adds the body to the get basket params
func (o *GetBasketParams) WithBody(body *models.BasketspbGetBasketRequest) *GetBasketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get basket params
func (o *GetBasketParams) SetBody(body *models.BasketspbGetBasketRequest) {
	o.Body = body
}
