...
func (o *CheckoutBasketOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/checkout_basket][%d] checkoutBasketOK  %+v", 200, o.Payload)
}
...
func (o *CheckoutBasketDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/checkout_basket][%d] checkoutBasket default  %+v", o._statusCode, o.Payload)
}
