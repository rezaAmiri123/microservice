...
func (o *StartBasketOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/start_basket][%d] startBasketOK  %+v", 200, o.Payload)
}
...
func (o *StartBasketDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/start_basket][%d] startBasket default  %+v", o._statusCode, o.Payload)
}
