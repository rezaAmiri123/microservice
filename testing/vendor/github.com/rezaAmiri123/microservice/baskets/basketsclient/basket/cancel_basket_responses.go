...
func (o *CancelBasketOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/cancel_basket][%d] cancelBasketOK  %+v", 200, o.Payload)
}
...
func (o *CancelBasketDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/baskets/cancel_basket][%d] cancelBasket default  %+v", o._statusCode, o.Payload)
}
