...
type CancelBasketParams struct {
	...
	// Body.
	Body *models.BasketspbCancelBasketRequest
...
// WithBody adds the body to the cancel basket params
func (o *CancelBasketParams) WithBody(body *models.BasketspbCancelBasketRequest) *CancelBasketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel basket params
func (o *CancelBasketParams) SetBody(body *models.BasketspbCancelBasketRequest) {
	o.Body = body
}
