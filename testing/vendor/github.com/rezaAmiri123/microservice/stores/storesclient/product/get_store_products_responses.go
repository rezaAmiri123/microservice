...
func (o *GetStoreProductsOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_catalog][%d] getStoreProductsOK  %+v", 200, o.Payload)
}
...
func (o *GetStoreProductsDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_catalog][%d] getStoreProducts default  %+v", o._statusCode, o.Payload)
}
