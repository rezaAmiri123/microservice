...
func (o *RemoveProductOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/remove_product][%d] removeProductOK  %+v", 200, o.Payload)
}
...
func (o *RemoveProductDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/remove_product][%d] removeProduct default  %+v", o._statusCode, o.Payload)
}
