...
type GetStoreProductsParams struct {
	...
	// Body.
	Body *models.StorespbGetCatalogRequest
...
// WithBody adds the body to the get store products params
func (o *GetStoreProductsParams) WithBody(body *models.StorespbGetCatalogRequest) *GetStoreProductsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get store products params
func (o *GetStoreProductsParams) SetBody(body *models.StorespbGetCatalogRequest) {
	o.Body = body
}
