...
func (o *IncreaseProductPriceOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/increase_product_price][%d] increaseProductPriceOK  %+v", 200, o.Payload)
}
...
func (o *IncreaseProductPriceDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/increase_product_price][%d] increaseProductPrice default  %+v", o._statusCode, o.Payload)
}
