...
func (o *AddProductOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/add_product][%d] addProductOK  %+v", 200, o.Payload)
}
...
func (o *AddProductDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/add_product][%d] addProduct default  %+v", o._statusCode, o.Payload)
}
