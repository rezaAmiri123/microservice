...
type GetProductParams struct {
	...
	// Body.
	Body *models.StorespbGetProductRequest
...
func (o *GetProductParams) WithBody(body *models.StorespbGetProductRequest) *GetProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get product params
func (o *GetProductParams) SetBody(body *models.StorespbGetProductRequest) {
	o.Body = body
}
