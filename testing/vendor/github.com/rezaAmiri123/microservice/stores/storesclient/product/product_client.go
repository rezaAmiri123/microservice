...
Use this API to add a new product
*/
func (a *Client) AddProduct(params *AddProductParams, opts ...ClientOption) (*AddProductOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "addProduct",
		Method:             "POST",
		PathPattern:        "/v1/api/stores/add_product",
...
/*
DecreaseProductPrice decreases a product price

Use this API to decrease a product price
*/
func (a *Client) DecreaseProductPrice(params *DecreaseProductPriceParams, opts ...ClientOption) (*DecreaseProductPriceOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v1/api/stores/decrease_product_price",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
func (a *Client) GetProduct(params *GetProductParams, opts ...ClientOption) (*GetProductOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getProduct",
		Method:             "POST",
		PathPattern:        "/v1/api/stores/get_product",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
GetStoreProducts gets a catalog

Use this API to get a catalog
*/
func (a *Client) GetStoreProducts(params *GetStoreProductsParams, opts ...ClientOption) (*GetStoreProductsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getStoreProducts",
		Method:             "POST",
		PathPattern:        "/v1/api/stores/get_catalog",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
IncreaseProductPrice increases a product price

Use this API to increase a product price
*/
func (a *Client) IncreaseProductPrice(params *IncreaseProductPriceParams, opts ...ClientOption) (*IncreaseProductPriceOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v1/api/stores/increase_product_price",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
Use this API to rebrand a product
*/
func (a *Client) RebrandProduct(params *RebrandProductParams, opts ...ClientOption) (*RebrandProductOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "rebrandProduct",
		Method:             "POST",
		PathPattern:        "/v1/api/stores/rebrand_product",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
Use this API to remove a product
*/
func (a *Client) RemoveProduct(params *RemoveProductParams, opts ...ClientOption) (*RemoveProductOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "removeProduct",
		Method:             "POST",
		PathPattern:        "/v1/api/stores/remove_product",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
