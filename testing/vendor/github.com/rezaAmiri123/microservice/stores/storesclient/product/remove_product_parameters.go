...
type RemoveProductParams struct {
	...
	// Body.
	Body *models.StorespbRemoveProductRequest
...
// WithBody adds the body to the remove product params
func (o *RemoveProductParams) WithBody(body *models.StorespbRemoveProductRequest) *RemoveProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the remove product params
func (o *RemoveProductParams) SetBody(body *models.StorespbRemoveProductRequest) {
	o.Body = body
}
