...
type IncreaseProductPriceParams struct {
	...
	// Body.
	Body *models.StorespbIncreaseProductPriceRequest
...
func (o *IncreaseProductPriceParams) WithBody(body *models.StorespbIncreaseProductPriceRequest) *IncreaseProductPriceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the increase product price params
func (o *IncreaseProductPriceParams) SetBody(body *models.StorespbIncreaseProductPriceRequest) {
	o.Body = body
}
