...
/*
DisableParticipation disables participation

Use this API to disable participation
*/
func (a *Client) DisableParticipation(params *DisableParticipationParams, opts ...ClientOption) (*DisableParticipationOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v1/api/stores/disable_participation",
...
/*
EnableParticipation enables participation

Use this API to enable participation
*/
func (a *Client) EnableParticipation(params *EnableParticipationParams, opts ...ClientOption) (*EnableParticipationOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v1/api/stores/enable_participation",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
...
/*
GetParticipatingStores gets participation stores

Use this API to get participation stores
*/
func (a *Client) GetParticipatingStores(params *GetParticipatingStoresParams, opts ...ClientOption) (*GetParticipatingStoresOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v1/api/stores/get_participation_stores",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
