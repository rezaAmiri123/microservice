...
func (o *EnableParticipationOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/enable_participation][%d] enableParticipationOK  %+v", 200, o.Payload)
}
...
func (o *EnableParticipationDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/enable_participation][%d] enableParticipation default  %+v", o._statusCode, o.Payload)
}
