...
type EnableParticipationParams struct {
	...
	// Body.
	Body *models.StorespbEnableParticipationRequest
...
func (o *EnableParticipationParams) WithBody(body *models.StorespbEnableParticipationRequest) *EnableParticipationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the enable participation params
func (o *EnableParticipationParams) SetBody(body *models.StorespbEnableParticipationRequest) {
	o.Body = body
}
