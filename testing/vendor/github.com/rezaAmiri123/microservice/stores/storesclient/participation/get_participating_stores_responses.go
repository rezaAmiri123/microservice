...
// Code gets the status code for the get participating stores o k response
func (o *GetParticipatingStoresOK) Code() int {
	return 200
}

func (o *GetParticipatingStoresOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_participation_stores][%d] getParticipatingStoresOK  %+v", 200, o.Payload)
}
...
func (o *GetParticipatingStoresDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_participation_stores][%d] getParticipatingStores default  %+v", o._statusCode, o.Payload)
}
