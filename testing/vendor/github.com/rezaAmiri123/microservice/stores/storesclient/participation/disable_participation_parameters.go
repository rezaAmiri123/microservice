...
type DisableParticipationParams struct {
	...
	// Body.
	Body *models.StorespbDisableParticipationRequest
...
// WithBody adds the body to the disable participation params
func (o *DisableParticipationParams) WithBody(body *models.StorespbDisableParticipationRequest) *DisableParticipationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the disable participation params
func (o *DisableParticipationParams) SetBody(body *models.StorespbDisableParticipationRequest) {
	o.Body = body
}
