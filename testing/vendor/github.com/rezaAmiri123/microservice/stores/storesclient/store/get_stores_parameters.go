...
type GetStoresParams struct {
	...
	// Body.
	Body models.StorespbGetStoresRequest
...
// WithBody adds the body to the get stores params
func (o *GetStoresParams) WithBody(body models.StorespbGetStoresRequest) *GetStoresParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get stores params
func (o *GetStoresParams) SetBody(body models.StorespbGetStoresRequest) {
	o.Body = body
}
