...
// Code gets the status code for the get store o k response
func (o *GetStoreOK) Code() int {
	return 200
}

func (o *GetStoreOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_store][%d] getStoreOK  %+v", 200, o.Payload)
}
...
func (o *GetStoreDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_store][%d] getStore default  %+v", o._statusCode, o.Payload)
}
