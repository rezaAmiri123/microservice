...
func (o *GetStoresOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_stores][%d] getStoresOK  %+v", 200, o.Payload)
}
...
func (o *GetStoresDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_stores][%d] getStores default  %+v", o._statusCode, o.Payload)
}
