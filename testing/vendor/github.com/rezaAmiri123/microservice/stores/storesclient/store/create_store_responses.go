...
func (o *CreateStoreOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/create_store][%d] createStoreOK  %+v", 200, o.Payload)
}
...
func (o *CreateStoreDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/create_store][%d] createStore default  %+v", o._statusCode, o.Payload)
}
