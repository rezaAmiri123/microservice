...
type RebrandStoreParams struct {
	...
	// Body.
	Body *models.StorespbRebrandStoreRequest
...
func (o *RebrandStoreParams) WithBody(body *models.StorespbRebrandStoreRequest) *RebrandStoreParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the rebrand store params
func (o *RebrandStoreParams) SetBody(body *models.StorespbRebrandStoreRequest) {
	o.Body = body
}
