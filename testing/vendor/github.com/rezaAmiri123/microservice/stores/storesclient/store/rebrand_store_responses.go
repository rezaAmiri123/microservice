...
func (o *RebrandStoreOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/rebrand_store][%d] rebrandStoreOK  %+v", 200, o.Payload)
}
...
func (o *RebrandStoreDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/rebrand_store][%d] rebrandStore default  %+v", o._statusCode, o.Payload)
}
