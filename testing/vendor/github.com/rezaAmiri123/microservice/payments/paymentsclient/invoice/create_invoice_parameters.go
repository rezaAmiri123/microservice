...
type CreateInvoiceParams struct {
	...
	// Body.
	Body *models.PaymentspbCreateInvoiceRequest
...
func (o *CreateInvoiceParams) WithBody(body *models.PaymentspbCreateInvoiceRequest) *CreateInvoiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create invoice params
func (o *CreateInvoiceParams) SetBody(body *models.PaymentspbCreateInvoiceRequest) {
	o.Body = body
}
