...
func (o *PayInvoiceOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/payments/pay_invoice][%d] payInvoiceOK  %+v", 200, o.Payload)
}
...
func (o *PayInvoiceDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/payments/pay_invoice][%d] payInvoice default  %+v", o._statusCode, o.Payload)
}
