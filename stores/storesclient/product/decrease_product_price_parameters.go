...
type DecreaseProductPriceParams struct {
	...
	// Body.
	Body *models.StorespbDecreaseProductPriceRequest
...
func (o *DecreaseProductPriceParams) WithBody(body *models.StorespbDecreaseProductPriceRequest) *DecreaseProductPriceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the decrease product price params
func (o *DecreaseProductPriceParams) SetBody(body *models.StorespbDecreaseProductPriceRequest) {
	o.Body = body
}
