...
func (o *GetProductOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_product][%d] getProductOK  %+v", 200, o.Payload)
}
...
func (o *GetProductDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/get_product][%d] getProduct default  %+v", o._statusCode, o.Payload)
}
