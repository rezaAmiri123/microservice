...
// Code gets the status code for the rebrand product o k response
func (o *RebrandProductOK) Code() int {
	return 200
}

func (o *RebrandProductOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/rebrand_product][%d] rebrandProductOK  %+v", 200, o.Payload)
}
...
func (o *RebrandProductDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/rebrand_product][%d] rebrandProduct default  %+v", o._statusCode, o.Payload)
}
