...
type RebrandProductParams struct {
	...
	// Body.
	Body *models.StorespbRebrandProductRequest
...
func (o *RebrandProductParams) WithBody(body *models.StorespbRebrandProductRequest) *RebrandProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the rebrand product params
func (o *RebrandProductParams) SetBody(body *models.StorespbRebrandProductRequest) {
	o.Body = body
}
