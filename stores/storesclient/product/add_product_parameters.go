...
type AddProductParams struct {
	...
	// Body.
	Body *models.StorespbAddProductRequest
...
func (o *AddProductParams) WithBody(body *models.StorespbAddProductRequest) *AddProductParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add product params
func (o *AddProductParams) SetBody(body *models.StorespbAddProductRequest) {
	o.Body = body
}
