...
// Code gets the status code for the disable participation o k response
func (o *DisableParticipationOK) Code() int {
	return 200
}

func (o *DisableParticipationOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/disable_participation][%d] disableParticipationOK  %+v", 200, o.Payload)
}
...
func (o *DisableParticipationDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/stores/disable_participation][%d] disableParticipation default  %+v", o._statusCode, o.Payload)
}
