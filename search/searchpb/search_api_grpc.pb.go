...
const (
	SearchService_SearchOrders_FullMethodName = "/basketspb.SearchService/SearchOrders"
	SearchService_GetOrder_FullMethodName     = "/basketspb.SearchService/GetOrder"
)
...
func (c *searchServiceClient) SearchOrders(ctx context.Context, in *SearchOrdersRequest, opts ...grpc.CallOption) (*SearchOrdersResponse, error) {
	...
	err := c.cc.Invoke(ctx, SearchService_SearchOrders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "basketspb.SearchService",
