...
import (
	...
	"github.com/rezaAmiri123/microservice/search/internal/ports/rest"
...
func (a *Agent) setupGrpcEndpoint(mux *chi.Mux) error {
	...
	err := searchpb.RegisterSearchServiceHandlerFromEndpoint(context.Background(), gateway, grpcAddress, []grpc.DialOption{
