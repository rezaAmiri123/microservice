...
import (
	...
	"github.com/rezaAmiri123/microservice/depot/internal/ports/rest"
...
func (a *Agent) setupGrpcEndpoint(mux *chi.Mux) error {
	...
	err := depotpb.RegisterDepotServiceHandlerFromEndpoint(context.Background(), gateway, grpcAddress, []grpc.DialOption{
