...
import (
	...
	"github.com/rezaAmiri123/microservice/notifications/internal/ports/rest"
...
func (a *Agent) setupSwagger(mux *chi.Mux) {
	...
	const specRoot = "/notification-spec/"
...
func (a *Agent) setupGrpcEndpoint(mux *chi.Mux) error {
	...
	err := notificationspb.RegisterNotificationsServiceHandlerFromEndpoint(context.Background(), gateway, grpcAddress, []grpc.DialOption{
