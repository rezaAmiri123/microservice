...
type CreateTransferRequest struct {
	...
	FromAccountId []byte `protobuf:"bytes,1,opt,name=from_account_id,json=fromAccountId,proto3" json:"from_account_id,omitempty"`
	ToAccountId   []byte `protobuf:"bytes,2,opt,name=to_account_id,json=toAccountId,proto3" json:"to_account_id,omitempty"`
...
func (x *CreateTransferRequest) GetFromAccountId() []byte {
	if x != nil {
...
func (x *CreateTransferRequest) GetToAccountId() []byte {
	if x != nil {
...
var file_rpc_create_transfer_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0c, 0x52, 0x0d, 0x66, 0x72, 0x6f, 0x6d, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x49, 0x64, 0x12, 0x22, 0x0a, 0x0d, 0x74, 0x6f, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x74, 0x6f, 0x41, 0x63, 0x63,
