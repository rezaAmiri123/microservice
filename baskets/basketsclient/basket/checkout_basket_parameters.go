...
type CheckoutBasketParams struct {
	...
	// Body.
	Body *models.BasketspbCheckoutBasketRequest
...
func (o *CheckoutBasketParams) WithBody(body *models.BasketspbCheckoutBasketRequest) *CheckoutBasketParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the checkout basket params
func (o *CheckoutBasketParams) SetBody(body *models.BasketspbCheckoutBasketRequest) {
	o.Body = body
}
