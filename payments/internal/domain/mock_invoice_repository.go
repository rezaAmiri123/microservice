...
func (_m *MockInvoiceRepository) Find(ctx context.Context, invoiceID string) (*Invoice, error) {
...
func (_m *MockInvoiceRepository) Save(ctx context.Context, invoice *Invoice) error {
	ret := _m.Called(ctx, invoice)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *Invoice) error); ok {
		r0 = rf(ctx, invoice)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockInvoiceRepository) Update(ctx context.Context, invoice *Invoice) error {
	ret := _m.Called(ctx, invoice)
