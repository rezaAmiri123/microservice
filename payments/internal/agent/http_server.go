...
import (
	...
	"github.com/rezaAmiri123/microservice/payments/internal/ports/rest"
...
func (a *Agent) setupSwagger(mux *chi.Mux) {
	...
	const specRoot = "/payments-swagger/"
...
func (a *Agent) setupGrpcEndpoint(mux *chi.Mux) error {
	...
	err := paymentspb.RegisterPaymentsServiceHandlerFromEndpoint(context.Background(), gateway, grpcAddress, []grpc.DialOption{
