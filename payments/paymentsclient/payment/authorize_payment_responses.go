...
// Code gets the status code for the authorize payment o k response
func (o *AuthorizePaymentOK) Code() int {
	return 200
}

func (o *AuthorizePaymentOK) Error() string {
	return fmt.Sprintf("[POST /v1/api/payments/authorize_payment][%d] authorizePaymentOK  %+v", 200, o.Payload)
}
...
func (o *AuthorizePaymentDefault) Error() string {
	return fmt.Sprintf("[POST /v1/api/payments/authorize_payment][%d] authorizePayment default  %+v", o._statusCode, o.Payload)
}
