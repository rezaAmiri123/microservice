...
type PayInvoiceParams struct {
	...
	// Body.
	Body *models.PaymentspbPayInvoiceRequest
...
func (o *PayInvoiceParams) WithBody(body *models.PaymentspbPayInvoiceRequest) *PayInvoiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the pay invoice params
func (o *PayInvoiceParams) SetBody(body *models.PaymentspbPayInvoiceRequest) {
	o.Body = body
}
