...
type LoginParams struct {
	...
	// Body.
	Body *models.UserspbLoginUserRequest
...
func (o *LoginParams) WithBody(body *models.UserspbLoginUserRequest) *LoginParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the login params
func (o *LoginParams) SetBody(body *models.UserspbLoginUserRequest) {
	o.Body = body
}
