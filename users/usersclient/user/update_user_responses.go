...
type UpdateUserOK struct {
	Payload *models.UserspbUpdateUserResponse
}
...
func (o *UpdateUserOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/update_user][%d] updateUserOK  %+v", 200, o.Payload)
}
...
func (o *UpdateUserDefault) Error() string {
	return fmt.Sprintf("[PATCH /v1/update_user][%d] updateUser default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateUserDefault) GetPayload() *models.RPCStatus {
	return o.Payload
}
